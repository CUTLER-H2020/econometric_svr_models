...
def print_output(userID):
    ...
    #        print "Results file not found - Please contact platform administrator"
        ...
        popover_text = "CUTLER economic model provides results in terms of long-run percentage deviations from the " \
                       "baseline, which captures the economy in the absence of policy interventions. For example, " \
                       "if the simulation shows a manufacturing sales impact of 0.2% for a city, the interpretation " \
                       "is that policy intervention shifted city's manufacturing sales upwards by 0.2% compared to " \
                       "an identical economy without policy intervention. The simulation is therefore meant to " \
                       "isolate the pure policy effect. "
        print "<h5 class='list-group-item list-group-item-success'><strong>CUTLER economic model executed " \
              "successfully. Please check below the results.</strong> "
        print "<span type='button' data-toggle='popover' data-placement='bottom' title='Learn more' " \
              "data-content='%s'><i class='fa fa-info-circle'></i></span>" % (
                  popover_text)
        print "</h5>"
        print "<br>"
...
def print_selected_input(form):
    ...
    # get town name - scenario name
    if form.getvalue('towns'):
        print "<a class='list-group-item list-group-item-action'><h5>Town: %s</h5></a>" % (
            str(form.getvalue('towns')).capitalize())

    if form.getvalue('scenario'):
        print "<a class='list-group-item list-group-item-action'><h5>Scenario: %s</h5></a>" % (
            str(form.getvalue('scenario')))

    for key in form.keys():
        for keys in key.split("-"):
            if keys in parameters:
                print "<a class='list-group-item list-group-item-action'><h5>%s: %s</h5></a>" % (
                    parameters[keys]['name'], str(form[key].value))
    print '</ul>'
...
def print_diagram(filename, title, unit, type):
    ...
    # print "tooltip: {formatter: function () {return 'Year: <b>' + this.x +'</b><br>"+ title +": <b>' + this.y +
    # '</b>';}},"
    ...
    print "}],"
    print "responsive: {rules: [{condition: {maxWidth: 500},chartOptions: {legend: {layout: 'horizontal'," \
...
def print_diagrams(town):
    ...
    if town == "antalya":
        ...
        print "<div class='tab-content'>"
        print "<div class='tab-pane active' id='first'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/6e71c470-2292' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2008-01-28T11%3A13%3A17.422Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T11%3A28%3A17.423Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='second'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/b5622af0-2292' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2003-01-28T11%3A14%3A55.915Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T11%3A29%3A55.915Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='third'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/f9223910-2292' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2012-01-28T11%3A16%3A14.233Z\'%2Cmode%3Aabsolute%2Cto%3A\'2019-01-28T11%3A31%3A14.233Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='fourth'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/4039d6a0-2293' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2001-01-28T11%3A19%3A11.990Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T11%3A34%3A11.991Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='fifth'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/2b464340-2294' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2011-01-28T11%3A20%3A43.130Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T11%3A35%3A43.130Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='sixth'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/5f6130e0-2294' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2001-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='seventh'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/9e948af0-2294' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2008-01-28T11%3A22%3A37.020Z\'%2Cmode%3Aabsolute%2Cto%3A\'2017-01-28T11%3A37%3A37.020Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"
        # closes tabs
        ...
        print "<ul class='nav nav-tabs nav-justified' id='myTab'>"
        print "<li class='active'><a data-target='#first' data-toggle='tab'>Total population of the metropolitan " \
              "area (persons)</a></li> "
        print "<li><a data-target='#second' data-toggle='tab'>GDP per capita ($)</a></li>"
        ...
        print "<div class='tab-content'>"
        print "<div class='tab-pane active' id='first'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/5386a9c0-2290' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2002-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='second'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/fa4a93d0-228f' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2004-01-28T11%3A30%3A56.282Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T11%3A45%3A56.282Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='third'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/4b27e9a0-2291' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2003-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"
        ...
        print "<div class='tab-content'>"
        print "<div class='tab-pane active' id='first'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/67410130-228c' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2007-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='second'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/cdf126d0-228c' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2007-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2017-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='third'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/0ea68d00-228d' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'1999-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2016-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='fourth'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/51727720-228d' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'1974-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2017-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"
        ...
        print "<div class='tab-content'>"
        print "<div class='tab-pane active' id='first'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/7a2081a0-228b' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2002-01-28T10%3A33%3A52.736Z\'%2Cmode%3Aabsolute%2Cto%3A\'2018-01-28T10%3A48%3A52.736Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='second'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/0ec01a60-228b' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2004-01-28T10%3A33%3A29.039Z\'%2Cmode%3Aabsolute%2Cto%3A\'2019-01-28T10%3A48%3A29.039Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"

        print "<div class='tab-pane' id='third'>"
        iframe = '<iframe src="http://snf-859370.vm.okeanos.grnet.gr:5601/app/kibana#/visualize/edit/f0ce9620-228b' \
                 '-11e9-9237-5f30eb781b9f?embed=true&_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(' \
                 'from%3A\'2003-06-05T17%3A57%3A55.758Z\'%2Cmode%3Aabsolute%2Cto%3A\'2019-05-07T19%3A09%3A23.392Z' \
                 '\'))" height="600" width="100%" style="border: none;"></iframe> '
        print iframe
        print "</div>"
